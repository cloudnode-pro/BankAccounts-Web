...
export default class Home extends Page {
    public constructor() {
        ...
        this.append(new Component("div")
            .class("min-h-screen", "bg-neutral-950").html`
            ...
            <div class="mx-auto max-w-7xl px-2 pt-16 pb-8 sm:px-6 sm:pt-24 lg:px-8 lg:pt-32">
              ...
              <dl class="mt-10 grid grid-cols-3 gap-8 text-base/7 text-neutral-300 lg:max-w-none">
                ...
                ${this.feature("Transactions History.",
                    ...
                    new Lucide.History)}
                ${this.feature("Payment Requests & Invoices.",
                ...
                ${this.feature("Customisable Settings.",
          ...
          <footer class="border-t border-neutral-800 bg-neutral-950">
            <div class="mx-auto max-w-7xl px-2 pt-16 pb-8 sm:px-6 sm:pt-24 lg:px-8 lg:pt-32">
              ...
              <div class="mt-16 flex justify-center space-x-10">
                <a href="https://modrinth.com/plugin/bankaccounts" rel="me" target="_blank"
                   class="text-neutral-400 rounded-full hover:text-neutral-300 outline-green-400 focus-visible:outline-2 focus-visible:outline-offset-8">
                  <span class="sr-only">Modrinth</span>
                  ${new Brand.Modrinth().class("size-6").set("ariaHidden", "true")}
                </a>
                <a href="https://github.com/cloudnode-pro/BankAccounts" rel="me" target="_blank"
                   class="text-neutral-400 rounded-full hover:text-neutral-300 outline-green-400 focus-visible:outline-2 focus-visible:outline-offset-8">
                  <span class="sr-only">GitHub</span>
                  ${new Brand.GitHub().class("size-6").set("ariaHidden", "true")}
                </a>
                <a href="https://matrix.to/#/#bankaccounts:cloudnode.pro" rel="me" target="_blank"
                   class="text-neutral-400 rounded-full hover:text-neutral-300 outline-green-400 focus-visible:outline-2 focus-visible:outline-offset-8">
                  <span class="sr-only">Matrix</span>
                  ${new Brand.Matrix().class("size-6").set("ariaHidden", "true")}
                </a>
                <a href="https://mastodon.social/@cloudnode" rel="me" target="_blank"
                   class="text-neutral-400 rounded-full hover:text-neutral-300 outline-green-400 focus-visible:outline-2 focus-visible:outline-offset-8">
                  <span class="sr-only">Mastodon</span>
                  ${new Brand.Mastodon().class("size-6").set("ariaHidden", "true")}
                </a>
                <a href="https://www.spigotmc.org/resources/bankaccounts.112092/" rel="me" target="_blank"
                   class="text-neutral-400 rounded-full hover:text-neutral-300 outline-green-400 focus-visible:outline-2 focus-visible:outline-offset-8">
                  <span class="sr-only">SpigotMC</span>
                  ${new Brand.SpigotMC().class("size-6").set("ariaHidden", "true")}
                </a>
              </div>
              <p class="mt-10 text-center text-xs leading-5 text-neutral-400">Copyright © 2025 Cloudnode OÜ.
                All rights reserved. The BankAccounts plugin is licensed under the <a
                    class="font-semibold hover:text-neutral-100 outline-green-400 focus-visible:outline-2 focus-visible:outline-offset-2"
                    href="https://www.gnu.org/licenses/gpl-3.0.html" target="_blank">GPL-3.0</a>.</p>
              <p class="text-center text-xs leading-5 text-neutral-400">NOT AN OFFICIAL MINECRAFT PRODUCT. NOT
                APPROVED BY OR ASSOCIATED WITH MOJANG OR MICROSOFT.</p>
            </div>
          </footer>
        `);
    }
    ...
    private footerLink(name: string, link: string) {
        return new Component<HTMLAnchorElement>("a")
            .set("href", link)
            .class("text-sm", "leading-6", "text-neutral-300", "rounded-full", "hover:text-neutral-100",
                "outline-green-400", "focus-visible:outline-2", "focus-visible:outline-offset-4")
            .text(name)
            .context(a => {
                if (new URL(link, location.href).origin !== location.origin) a.set("target", "_blank");
            });
    }
}
